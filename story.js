...
(function () {
	...
	var disableLinkClick = function (link) {
    ...
    var newSection = function() {
        if (currentSection) {
            disableLinkClick(jQuery('.squiffy-link', currentSection));
        }
